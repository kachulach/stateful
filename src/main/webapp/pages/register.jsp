...
<body ng-app="validationApp" ng-controller="mainController"
	<%if (request.getAttribute("msg") != null) out.println("onload=\"showModal()\"");%>>
			...
			<!-- Register -->
				<div class="container">
					...
					<form method="post"	action="${pageContext.request.contextPath}/game/register"
						name="userForm" ng-submit="submitForm()" novalidate
					>
						<h2>
						...
						<hr class="colorgraph">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group" ng-class="{ 'has-error' : userForm.first_name.$invalid && !userForm.first_name.$pristine }">
										<input type="text" name="first_name" id="first_name" class="form-control input-lg"
											...
											placeholder="име" tabindex="1" data-ng-model="first_name" required											
										>
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group" ng-class="{ 'has-error' : userForm.last_name.$invalid && !userForm.last_name.$pristine }">
										<input type="text" name="last_name" id="last_name" class="form-control input-lg "
											...
											placeholder="презиме" tabindex="2" data-ng-model="last_name"	required											
										>
										<p ng-show="userForm.last_name.$invalid && !userForm.last_name.$pristine" class="help-block">
											Презимето е задолжително
										</p>
									</div>
								</div>
							</div>
							...
							<div class="form-group" ng-class="{ 'has-error' : userForm.usernameF.$invalid && !userForm.usernameF.$pristine }">
								<input type="text" name="usernameF" id="usernameF" class="form-control input-lg"
									...
									placeholder="корисничко име" tabindex="3" data-ng-model="usernameF" required									
								>
								<p ng-show="userForm.usernameF.$invalid && !userForm.usernameF.$pristine" class="help-block">
									Корисничкото име е задолжително
								</p>
							</div>
							...
							<div class="form-group" ng-class="{ 'has-error' : userForm.email.$invalid && !userForm.email.$pristine }"> 
								<input type="email" name="email" id="email" class="form-control input-lg"
									...
									placeholder="емаил" tabindex="4" data-ng-model="email" required									
								>
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group" ng-class="{ 'has-error' : userForm.passwd.$invalid && !userForm.passwd.$pristine }">
										<input type="password" name="passwd" id="passwd" class="form-control input-lg" placeholder="лозинка"
											tabindex="5" ng-model="passwd" required											
										>
										<p ng-show="userForm.passwd.$invalid && !userForm.passwd.$pristine"	class="help-block">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group" ng-class="{ 'has-error' : userForm.password_confirmation.$invalid && !userForm.password_confirmation.$pristine }">
										<input type="password" name="password_confirmation"	id="password_confirmation" class="form-control input-lg"
											placeholder="потврди ја лозинката" tabindex="6"
											ng-model="password_confirmation" required
											pw-check="passwd"			
										>						
										<div class="help-block" ng-show="userForm.$error" ng-class="{ 'has-error' : userForm.$error }"> 
											<span class="help-block" ng-show="userForm.password_confirmation.$error.pwmatch">
							...
							<div class="row">
								<div class="col-xs-3 col-sm-3 col-md-3">
									<span class="button-checkbox">
										...
										<input type="checkbox" name="t_and_c" id="t_and_c" class="hidden" value="1" ng-model="chkbox"/>
									</span>
								</div>
								<div class="col-xs-9 col-sm-9 col-md-9">
									Со кликање на <strong class="label label-primary">Регистрирај се</strong>, 
									се согласуваш со Правилата и условите на оваа страна, како и користење на Cookie.
								</div>
							</div>
